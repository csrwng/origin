...
%{!?commit:
%global commit 0d15b1674f982a929a4ba2a85f2fcab64d8b570c
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_VERSION=v3.6.0-alpha.2+0d15b16-508 OS_GIT_MINOR=6+ OS_GIT_COMMIT=0d15b1674f OS_GIT_MAJOR=3 OS_GIT_TREE_STATE=clean
}
