...
func init() {
	...
	addControllerRole(rbac.ClusterRole{
		...
		Rules: []rbac.PolicyRule{
			...
			rbac.NewRule("create").Groups(buildGroup, legacyBuildGroup).Resources("builds/docker", "builds/optimizeddocker", "builds/source", "builds/custom", "builds/jenkinspipeline").RuleOrDie(),
			...
			rbac.NewRule("get", "list", "watch", "create", "delete").Groups(kapiGroup).Resources("pods").RuleOrDie(),
